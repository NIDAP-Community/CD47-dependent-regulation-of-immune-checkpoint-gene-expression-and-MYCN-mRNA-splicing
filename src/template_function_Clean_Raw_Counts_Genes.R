...
Clean_Raw_Counts_Genes <- function(CCBR_1188_Genes_and_TCR) {
...
#Basic Parameters:
raw_counts_matrix=CCBR_1188_Genes_and_TCR
...
print("template_function_Clean_Raw_Counts_Genes.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_CCBR_1188_Genes_and_TCR<-readRDS(paste0(rds_output,"/var_CCBR_1188_Genes_and_TCR.rds"))
Input_is_Seurat_count <- 0
for(item in var_CCBR_1188_Genes_and_TCR){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_CCBR_1188_Genes_and_TCR<-as.data.frame(var_CCBR_1188_Genes_and_TCR)}else{var_CCBR_1188_Genes_and_TCR <- var_CCBR_1188_Genes_and_TCR}
invisible(graphics.off())
var_Clean_Raw_Counts_Genes<-Clean_Raw_Counts_Genes(var_CCBR_1188_Genes_and_TCR)
invisible(graphics.off())
saveRDS(var_Clean_Raw_Counts_Genes, paste0(rds_output,"/var_Clean_Raw_Counts_Genes.rds"))

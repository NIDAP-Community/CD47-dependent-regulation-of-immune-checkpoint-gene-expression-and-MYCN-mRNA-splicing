# Normalization [CCBR] (afc2524c-9bae-4873-98c1-e06ef8f4632b): v258
Normalized_Counts_Isoforms <- function(Filtered_Counts_Isoforms, CCBR_1188_Metadata_Final) {
    ...
    #Basic Parameters:
    counts_matrix <- Filtered_Counts_Isoforms
    sample_metadata <- CCBR_1188_Metadata_Final
    gene_names_column <- "Gene"
    columns_to_include = c("Gene","JINB8_CD3_CD28_1","JINB8_CD3_CD28_3","JINB8_CD3_CD28_6","JINB8_CD3_CD28_TSP1_1","JINB8_CD3_CD28_TSP1_3","JINB8_CD3_CD28_TSP1_6","JINB8_TSP1_1","JINB8_TSP1_3","JINB8_TSP1_6","JINB8_UT_1","Jurkat_CD3_CD28_1","Jurkat_CD3_CD28_3","Jurkat_CD3_CD28_6","Jurkat_CD3_CD28_TSP1_1","Jurkat_CD3_CD28_TSP1_3","Jurkat_CD3_CD28_TSP1_6","Jurkat_TSP1_1","Jurkat_TSP1_3","Jurkat_TSP1_6","Jurkat_UT_1")
...
counts_matrix[,gene_names_column]=paste0(counts_matrix[,gene_names_column],'_',1:nrow(counts_matrix))
    ...
    png(
      filename="Normalized_Counts_Isoforms.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_Normalized_Counts_Isoforms.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_Filtered_Counts_Isoforms<-readRDS(paste0(rds_output,"/var_Filtered_Counts_Isoforms.rds"))
Input_is_Seurat_count <- 0
for(item in var_Filtered_Counts_Isoforms){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_Filtered_Counts_Isoforms<-as.data.frame(var_Filtered_Counts_Isoforms)}else{var_Filtered_Counts_Isoforms <- var_Filtered_Counts_Isoforms}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_Normalized_Counts_Isoforms<-Normalized_Counts_Isoforms(var_Filtered_Counts_Isoforms,var_CCBR_1188_Metadata_Final)
invisible(graphics.off())
saveRDS(var_Normalized_Counts_Isoforms, paste0(rds_output,"/var_Normalized_Counts_Isoforms.rds"))

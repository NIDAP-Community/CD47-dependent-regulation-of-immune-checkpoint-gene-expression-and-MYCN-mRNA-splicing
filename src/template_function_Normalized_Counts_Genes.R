...
Normalized_Counts_Genes <- function(Filtered_Counts_Genes, CCBR_1188_Metadata_Final) {
...
counts_matrix[,gene_names_column]=paste0(counts_matrix[,gene_names_column],'_',1:nrow(counts_matrix))
    ...
    png(
      filename="Normalized_Counts_Genes.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_Normalized_Counts_Genes.R #########################################################################")
...
var_Normalized_Counts_Genes<-Normalized_Counts_Genes(var_Filtered_Counts_Genes,var_CCBR_1188_Metadata_Final)
invisible(graphics.off())
saveRDS(var_Normalized_Counts_Genes, paste0(rds_output,"/var_Normalized_Counts_Genes.rds"))

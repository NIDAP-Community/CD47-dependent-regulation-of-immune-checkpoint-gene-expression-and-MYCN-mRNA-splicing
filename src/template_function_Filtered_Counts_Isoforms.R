# Filter Low Counts [CCBR] (59e7ee62-1715-4276-b370-e8395168f9d8): v718
Filtered_Counts_Isoforms <- function(Clean_Raw_Counts_Isoforms, CCBR_1188_Metadata_Final) {
    ...
    #Basic Parameters:
    counts_matrix = Clean_Raw_Counts_Isoforms
    sample_metadata <- CCBR_1188_Metadata_Final   
    gene_names_column <- "Gene"
    columns_to_include <- c("gene_id","GeneName","Gene","JINB8_CD3_CD28_1","JINB8_CD3_CD28_3","JINB8_CD3_CD28_6","JINB8_CD3_CD28_TSP1_1","JINB8_CD3_CD28_TSP1_3","JINB8_CD3_CD28_TSP1_6","JINB8_TSP1_1","JINB8_TSP1_3","JINB8_TSP1_6","JINB8_UT_1","Jurkat_CD3_CD28_1","Jurkat_CD3_CD28_3","Jurkat_CD3_CD28_6","Jurkat_CD3_CD28_TSP1_1","Jurkat_CD3_CD28_TSP1_3","Jurkat_CD3_CD28_TSP1_6","Jurkat_TSP1_1","Jurkat_TSP1_3","Jurkat_TSP1_6","Jurkat_UT_1")
...
#print(colnames(df.final))
    ...
    png(
      filename="Filtered_Counts_Isoforms.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_Filtered_Counts_Isoforms.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_Clean_Raw_Counts_Isoforms<-readRDS(paste0(rds_output,"/var_Clean_Raw_Counts_Isoforms.rds"))
Input_is_Seurat_count <- 0
for(item in var_Clean_Raw_Counts_Isoforms){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_Clean_Raw_Counts_Isoforms<-as.data.frame(var_Clean_Raw_Counts_Isoforms)}else{var_Clean_Raw_Counts_Isoforms <- var_Clean_Raw_Counts_Isoforms}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_Filtered_Counts_Isoforms<-Filtered_Counts_Isoforms(var_Clean_Raw_Counts_Isoforms,var_CCBR_1188_Metadata_Final)
invisible(graphics.off())
saveRDS(var_Filtered_Counts_Isoforms, paste0(rds_output,"/var_Filtered_Counts_Isoforms.rds"))

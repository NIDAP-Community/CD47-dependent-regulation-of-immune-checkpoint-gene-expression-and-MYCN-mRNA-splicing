Figure_S1G_MYC_Barplot <- function(Normalized_Transcript_logCPM) {
...
print("template_function_Figure_S1G_MYC_Barplot.R #########################################################################")
...
var_Figure_S1G_MYC_Barplot<-Figure_S1G_MYC_Barplot(var_Normalized_Transcript_logCPM)
invisible(graphics.off())
saveRDS(var_Figure_S1G_MYC_Barplot, paste0(rds_output,"/var_Figure_S1G_MYC_Barplot.rds"))

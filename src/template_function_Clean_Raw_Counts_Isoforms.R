...
Clean_Raw_Counts_Isoforms <- function(CCBR_1188_Isoforms_Rawcounts) {
...
#Basic Parameters:
raw_counts_matrix=CCBR_1188_Isoforms_Rawcounts
Data_type='Bulk RNAseq'
gene_id_column='transcript_id'
samples_to_rename = c("")
...
print("template_function_Clean_Raw_Counts_Isoforms.R #########################################################################")
...
var_Clean_Raw_Counts_Isoforms<-Clean_Raw_Counts_Isoforms(var_CCBR_1188_Isoforms_Rawcounts)
invisible(graphics.off())
saveRDS(var_Clean_Raw_Counts_Isoforms, paste0(rds_output,"/var_Clean_Raw_Counts_Isoforms.rds"))

...
Filtered_Counts_Genes <- function(Clean_Raw_Counts_Genes, CCBR_1188_Metadata_Final) {
    ...
    #Basic Parameters:
    counts_matrix = Clean_Raw_Counts_Genes
...
#print(colnames(df.final))
    ...
    png(
      filename="Filtered_Counts_Genes.png",
      width=imageWidth,
      height=imageHeight,
      units="px",
      pointsize=4,
...
print("template_function_Filtered_Counts_Genes.R #########################################################################")
library(plotly);library(ggplot2);library(jsonlite);
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
var_Clean_Raw_Counts_Genes<-readRDS(paste0(rds_output,"/var_Clean_Raw_Counts_Genes.rds"))
Input_is_Seurat_count <- 0
for(item in var_Clean_Raw_Counts_Genes){ if (class(item)=="Seurat"){Input_is_Seurat_count = Input_is_Seurat_count + 1}}
if(Input_is_Seurat_count == 0 ){
var_Clean_Raw_Counts_Genes<-as.data.frame(var_Clean_Raw_Counts_Genes)}else{var_Clean_Raw_Counts_Genes <- var_Clean_Raw_Counts_Genes}
currentdir <- getwd()
rds_output <- paste0(currentdir,'/rds_output')
...
var_Filtered_Counts_Genes<-Filtered_Counts_Genes(var_Clean_Raw_Counts_Genes,var_CCBR_1188_Metadata_Final)
invisible(graphics.off())
saveRDS(var_Filtered_Counts_Genes, paste0(rds_output,"/var_Filtered_Counts_Genes.rds"))
